                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 pull-right">
                                <div class="box-tools pull-right">
                                    <a href="{{route('page.create')}}" class="btn btn-success btn-new" data-title="नयाँ बनाउने" data-col-width="Medium"><i class="fa fa-plus"></i></a>
                                </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($pages as $k=>$v)
                                <tr>
                                    ...
                                    <td>{{$v->page_type}}</td>
                                    <td>
                                        <a href="{{route('page.edit',$v)}}" class="btn-edit btn-xs btn btn-primary" data-title="सम्पादन : नेपाल सरकार"><i class="fa fa-edit"></i></a>
                                        ...
                                        <form id="delete-form-{{$v->id}}" action="{{route('page.destroy',$v->id)}}" method="POST">
                                            {{csrf_field()}}
                                            {{method_field('DELETE')}}
