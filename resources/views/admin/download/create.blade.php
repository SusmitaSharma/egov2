...
<form action="{{$edit? route('download.update',$download->id):route('download.store')}}" class="form-horizontal"  method="post" id="userForm" enctype="multipart/form-data">
@csrf
@if($edit)
@method('PUT')
@endif
 ...
 <div class="box box-solid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <i class="fa fa-file"></i>
                             ...
                             <input class="form-control" id="Title" name="title" type="text" value="{{$edit?$download->title:old('title')}}" placeholder="शिर्षक">
                         </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                        ...
                        @else
                         ...
                         @if($download->isImage())
                         <img src="{{$download->image()}}" style="width: 150px" />
                         @else
                         @if($download->image)
                         <a href="{{route('download.download',$download->image)}}">{{$download->image}}(Clik To Download)</a>
                         @endif
                         @endif
        ...
        <div class="col-md-12">
            <div class="box box-footer" style="margin-top:-10; border-top: 1px solid #c1c1c1">
                ...
                <a href="{{route('download.index')}}" class="btn btn-default">Cancel</a>
            </div>
        </div>
    </div>
        </div>
